...
An easy way is to literally think about a $ per hour number. 
Economists model this as an hourly wage, which is fuzzier on a salaried job where more hours != more money. 
